...
//                String dateToDisplay = new java.text.SimpleDateFormat("dd-MM-yyyy HH:mm:ss").format(new java.util.Date (unixtime));

                // Create a new {@link Earthquake} object with the magnitude, location, time,
                // and url from the JSON response.
                Earthquake earthquake = new Earthquake(magnitude, location,dateToDisplay, url);
...
//                Date dateObject = new Date(Long.valueOf(time));
